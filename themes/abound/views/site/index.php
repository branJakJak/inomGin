...
Yii::app()->clientScript->registerScript('onApplicationReadyJsScriptCode', $onApplicationReadyJsScriptCode, CClientScript::POS_READY);

/*crafty clicks*/
Yii::app()->clientScript->registerScriptFile($baseUrl.'/js/crafty_postcode.class.js', CClientScript::POS_HEAD);
Yii::app()->clientScript->registerScriptFile('/REQUIREMENTS/assets/script/crafty_postcode.class.js', CClientScript::POS_HEAD);
...
<!-- <form id="details" name="details" method="post" action="add_client_ref.php"> -->
 ...
 <input type="hidden" name="PPI-taken" id="PPI-taken" /> 
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <input name="ppi_reason[]" type="checkbox" id="ppi_reason[]" value="2" /> 2. Didn't know there was PPI</td>
                <td>&nbsp;</td>
                <td>
                    <input name="ppi_reason[]" type="checkbox" id="ppi_reason[]" value="9" /> 9. Medical Condition</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>
                    <input name="ppi_reason[]" type="checkbox" id="ppi_reason[]" value="3" /> 3. Told it was complusory</td>
                <td>&nbsp;</td>
                <td>
                    <input name="ppi_reason[]" type="checkbox" id="ppi_reason[]" value="10" /> 10. Previously Offered insufficient refund</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>
                    <input name="ppi_reason[]" type="checkbox" id="ppi_reason[]" value="4" /> 4. Told it would assist credit</td>
                <td>&nbsp;</td>
                <td>
                    <input name="ppi_reason[]" type="checkbox" id="ppi_reason[]" value="11" /> 11. PPI Cost wasnt quoted</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>
                    <input name="ppi_reason[]" type="checkbox" id="ppi_reason[]" value="5" /> 5. Had alternative cover</td>
                <td>&nbsp;</td>
                <td>
                    <input name="ppi_reason[]" type="checkbox" id="ppi_reason[]" value="12" /> 12. No T&amp;C explanation</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>
                    <input name="ppi_reason[]" type="checkbox" id="ppi_reason[]" value="6" /> 6. Unqualified salesperson</td>
                <td>&nbsp;</td>
                <td>
                    <input name="ppi_reason[]" type="checkbox" id="ppi_reason[]" value="13" /> 13. Over 70 when policy started</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>
                    <input name="ppi_reason[]" type="checkbox" id="ppi_reason[]" value="7" /> 7. Insufficient cover</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
            <tr>
 ...
 <input type="hidden" name="taken" id="taken" /> 
            ...
            <tr>
                ...
                <td valign="middle">
                    ...
                    <br />
                    <textarea name="ope_specific" id="ope_specific" cols="45" rows="5" placeholder="e.g. If this is still open explain why and advise the client to close it ASAP." style="display:none;"></textarea>
                </td>
            </tr>
            <tr>
                ...
                <td valign="middle">
                    ...
                    <br />
                    <textarea name="ntc_specific" id="ntc_specific" cols="45" rows="5" placeholder="e.g. When did they notice the fees and what did the customer beleive this charge was for?" style="display:none;"></textarea>
                </td>
            ...
            <tr>
                ...
                <td valign="middle">
                    ...
                    <br />
                    <textarea name="othacc_specific" id="othacc_specific" cols="45" rows="5" placeholder="e.g. Give details of any other accounts the customer has." style="display:none;"></textarea>
                </td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
            ...
            <tr>
                ...
                <td valign="middle">
                    <input name="pba_benefits[]" type="checkbox" id="pba_benefits[]" value="1" /> 1. RAC / AA / Breakdown Cover</td>
                <td valign="middle">Mis-Sold Reason:</td>
                <td valign="middle">
                    <input name="pba_reason[]" type="checkbox" id="pba_reason[]" value="1" /> 1. Wasn't informed of alternative free account. *</td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_benefits[]" type="checkbox" id="pba_benefits[]" value="2" /> 2. Mobile Cover</td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_reason[]" type="checkbox" id="pba_reason[]" value="2" /> 2. Told they had to have it</td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_benefits[]" type="checkbox" id="pba_benefits[]" value="3" /> 3. Travel Insurance</td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_reason[]" type="checkbox" id="pba_reason[]" value="3" /> 3. Too old for the insurance</td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_benefits[]" type="checkbox" id="pba_benefits[]" value="4" /> 4. Overdraft</td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_reason[]" type="checkbox" id="pba_reason4" value="4" /> 4. Misled into taking the account
                    <br />
                    <textarea name="ml_specific" id="ml_specific" cols="45" rows="5" placeholder="e.g. they were told that taking the account would improve thier chances of an overdraft later on." style="display:none;"></textarea>
                </td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_benefits[]" type="checkbox" id="pba_benefits[]" value="5" /> 5. Home Emergency Cover</td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_reason[]" type="checkbox" id="pba_reason[]" value="5" /> 5. Hiked the price and didn't tell them</td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    ...
                    <br />
                    <textarea name="othben_specific" id="othben_specific" cols="45" rows="5" placeholder="e.g. Give details of other benefits attached to this account." style="display:none;"></textarea>
                </td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_reason[]" type="checkbox" id="pba_reason[]" value="6" /> 6. Added without their knowledge</td>
            </tr>
            <tr>
                <td valign="middle">Benefits Used:</td>
                <td valign="middle">
                    <input name="pba_benefits_used[]" type="checkbox" id="pba_benefits_used[]" value="1" /> 1. RAC / AA / Breakdown Cover </td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_reason[]" type="checkbox" id="pba_reason7" value="7" /> 7. Tried to cancel but forced to keep it
                    <br />
                    <textarea name="ca_specific" id="ca_specific" cols="45" rows="5" placeholder="e.g. when they attempted to cancel they were told that the overdraft facility would be removed." style="display:none;"></textarea>
                </td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_benefits_used[]" type="checkbox" id="pba_benefits_used[]" value="2" /> 2. Mobile Cover </td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_reason[]" type="checkbox" id="pba_reason8" value="8" /> 8. Requirements not mentioned
                    <br />
                    <textarea name="re_specific" id="re_specific" cols="45" rows="5" placeholder="e.g. they were not told that they must specify a phone to add for the phone insurance." style="display:none;"></textarea>
                </td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_benefits_used[]" type="checkbox" id="pba_benefits_used[]" value="3" /> 3. Travel Insurance </td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_reason[]" type="checkbox" id="pba_reason9" value="9" /> 9. Exclusions not satisfactorily explained
                    <br />
                    <textarea name="ex_specific" id="ex_specific" cols="45" rows="5" placeholder="e.g. they were not informed that thier phone would not be covered when left in the car." style="display:none;"></textarea>
                </td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_benefits_used[]" type="checkbox" id="pba_benefits_used[]" value="4" /> 4. Overdraft </td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_reason[]" type="checkbox" id="pba_reason[]" value="10" /> 10. Told it would improve credit rating</td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    ...
                    <br />
                    <textarea name="claim_specific" id="claim_specific" cols="45" rows="5" placeholder="e.g. Give details of claims the customer has made." style="display:none;"></textarea>
                </td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_reason[]" type="checkbox" id="pba_reason[]" value="11" /> 11. Told would receive special interest rates</td>
            </tr>
            <tr>
                ...
                <td valign="middle">
                    ...
                    <br />
                    <textarea name="regben_specific" id="regben_specific" cols="45" rows="5" placeholder="e.g. Details of benefits registered." style="display:none;"></textarea>
                </td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_reason[]" type="checkbox" id="pba_reason[]" value="12" /> 12. Felt obliged/coerced to take the account</td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">&nbsp;</td>
            ...
            <tr>
                ...
                <td valign="middle">
                    <input name="pba_tcf[]" type="checkbox" id="pba_tcf[]" value="1" /> 1. Didn't feel confident that they are dealing with firms where the fair treatment of customers is central to the corporate culture.</td>
            </tr>
            <tr>
                <td valign="middle">UK Resident:</td>
                <td valign="middle">
                    <input type="radio" name="pba_uk_resident" value="1" checked="checked" /> Yes
                    <input type="radio" name="pba_uk_resident" value="0" /> No (Over 183 days a year outside UK)</td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_tcf[]" type="checkbox" id="pba_tcf[]" value="2" /> 2. Account wasn't designed to meet the needs of identified consumer groups and are not targeted accordingly.</td>
            </tr>
            <tr>
                ...
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_tcf[]" type="checkbox" id="pba_tcf[]" value="3" /> 3. Not provided with clear information and kept appropriately informed before, during and after the point of sale.</td>
            </tr>
            <tr>
                ...
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_tcf[]" type="checkbox" id="pba_tcf[]" value="4" /> 4. Advice was unsuitable and did it take account of their circumstances.</td>
            </tr>
            <tr>
                ...
                <td valign="middle">
                    ...
                    <br />
                    <textarea name="af_specific" id="af_specific" cols="45" rows="5" placeholder="e.g. Our client's position in the armed forces means that they have specific medical care providers that are beyond the scope of this cover." style="display:none;"></textarea>
                </td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_tcf[]" type="checkbox" id="pba_tcf[]" value="5" /> 5. Account did not perform as firms have led them to expect, and the associated service is of an unacceptable standard.</td>
            </tr>
            <tr>
                ...
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_tcf[]" type="checkbox" id="pba_tcf[]" value="6" /> 6. Faced unreasonable post-sale barriers imposed by firms to change product, switch provider, submit a claim or make a complaint.</td>
            </tr>
            <tr>
                ...
                <td valign="middle">
                    ...
                    <input name="pba_welcome" type="radio" value="U" checked="checked" /> Don't Know</td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">&nbsp;</td>
            </tr>
            <tr>
                ...
                <td valign="middle">
                    ...
                    <input name="pba_terms" type="radio" value="U" checked="checked" /> Don't Know</td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="1" /> 1. Other Bank Cover</td>
            ...
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="2" /> 2. Other Gadget Insurer</td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
            ...
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="3" /> 3. Mobile Network Cover</td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
            ...
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="4" /> 4. Home Insurance</td>
                <td valign="middle">Breakdown Cover:</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="11" /> 1. Company Car</td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="5" /> 5. No Mobile Phone</td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="12" /> 2. No Car</td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="24" /> 6. No Smartphone</td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="13" /> 3. Third Party Cover</td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="21" /> 7. Declined Claim</td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="14" /> 4. Old Car</td>
            </tr>
            <tr>
                <td valign="middle">Travel Cover:</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="6" /> 1. Over Cover Age</td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="23" /> 5. Declined Claim</td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="7" /> 2. Doesn't Travel</td>
                <td valign="middle">Overdraft</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="16" /> 1. Wrongly Advised</td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="15" /> 3. Travels longer than 31 days</td>
                <td valign="middle">Home Emergency</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="17" /> 1. Third Party Cover</td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                ...
                <td valign="middle">
                    ...
                    <br />
                    <textarea name="health_specific" id="health_specific" cols="45" rows="5" placeholder="e.g. Give details of health problems." style="display:none;"></textarea>
                </td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="18" /> 2. Landlords Cover</td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="9" /> 5. Sought Own Cover</td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="19" /> 3. Parents / Other Accom</td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="10" /> 6. High Risk Travel</td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="20" /> 4. Declined Claim</td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_unsuitable[]" type="checkbox" id="pba_unsuitable[]" value="22" /> 7. Declined Claim</td>
                <td valign="middle">&nbsp;</td>
                <td valign="middle">
                    <input name="pba_othinskeep" type="checkbox" id="pba_othinskeep" value="TRUE" checked="checked" /> Kept other insurances after PBA sold
                    <br />
                    <textarea name="othins_specific" id="othins_specific" cols="45" rows="5" placeholder="e.g. Give details of why the customer cancelled the other insurances." style="display:none;"></textarea>
                </td>
            </tr>
            <tr>
    ...
    <table border="0" cellspacing="2px" cellpadding="2px" class="inputtbl" style=" border-top:none; padding:5px;">
        <tr>
            <td colspan="4" valign="top">
                <div align="center">
                    <button type="submit" name="Save" id="Save" value="Save" tabindex="27" class="savebutton">Save<img src="//icons.iconarchive.com/icons/dryicons/simplistica/32/accept-icon.png" witdh="15" height="15" />
                    </button>
                    <button type="reset" name="Reset" id="Reset" value="Reset" tabindex="28" class="resetbutton">Reset<img src="//icons.iconarchive.com/icons/kyo-tux/ginux/32/Extras-Close-icon.png" witdh="15" height="15" />
                    </button>
                </div>
            </td>
        </tr>
...
<script type="text/javascript">
    ...
    var sprytextfield1 = new Spry.Widget.ValidationTextField("spry_forename", "none", {
        validateOn: ["blur"]
    });
    var sprytextfield2 = new Spry.Widget.ValidationTextField("spry_surname", "none", {
        validateOn: ["blur"]
    });
    var sprytextfield3 = new Spry.Widget.ValidationTextField("spry_dob", "date", {
        format: "yyyy-mm-dd",
        validateOn: ["blur"],
    ...
    var sprytextfield8 = new Spry.Widget.ValidationTextField("spry_postcode", "none", {
        validateOn: ["blur"]
    });
    var sprytextfield9 = new Spry.Widget.ValidationTextField("spry_house", "none", {
        validateOn: ["blur"]
    });
    var sprytextfield10 = new Spry.Widget.ValidationTextField("spry_2_dob", "date", {
        isRequired: false,
        validateOn: ["blur"],
        format: "yyyy-mm-dd",
        useCharacterMasking: true
    ...
    var sprytextfield12 = new Spry.Widget.ValidationTextField("spry_2_email", "email", {
        isRequired: false,
        validateOn: ["blur"]
    });
    //-->
