...
<h1>View MainLeadModel #<?php echo $model->id; ?></h1>
...
//		'user_id',
        ...
        array(
            'name'=>'closer',
            'type'=>'raw',
            'value'=>'<strong id="'.$uniqId = uniqid().'">'.$model->closer.'</strong>'.CHtml::button(CHtml::encode($model->closer), array('class'=>'btn','data-clipboard-target'=>$uniqId)),
        ),
