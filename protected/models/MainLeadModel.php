 ...
 * @property string $kept_other_insurances_after_PBA_sold_specification
 * @property string $pba_othben
 *
...
class MainLeadModel extends CActiveRecord
{
    ...
    public $ml_specific;
    public $kept_other_insurances_after_PBA_sold_specification;
    public $pba_othben;
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'ml_specific' => "Missold Reason - Misled into taking reason",
            'kept_other_insurances_after_PBA_sold_specification' => "Kept Other Insurances after PBA sold specification",
            'pba_othben' => "Accounts benefit (Other)",
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('ml_specific', $this->ml_specific, true);
        $criteria->compare('kept_other_insurances_after_PBA_sold_specification', $this->kept_other_insurances_after_PBA_sold_specification, true);
        $criteria->compare('pba_othben', $this->pba_othben, true);
