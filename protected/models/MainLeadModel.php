...
class MainLeadModel extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('pba_specific_know_about_charge_specify',$this->pba_specific_know_about_charge_specify,true);
		...
		$criteria->compare('pba_specific_requirements_not_mentioned_specific',$this->pba_specific_requirements_not_mentioned_specific,true);
		$criteria->compare('pba_specific_exclusion_not_explained_specific',$this->pba_specific_exclusion_not_explained_specific,true);
		...
		$criteria->compare('pba_specific_registered_benefits_specify',$this->pba_specific_registered_benefits_specify,true);
